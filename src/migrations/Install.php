...
/**
 * OpenID Login Install Migration
 *
...
class Install extends Migration
{
    ...
    // imarc_openidlogin_record table
        $tableSchema = Craft::$app->db->schema->getTableSchema('{{%imarc_openidlogin_record}}');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
    ...
    protected function addForeignKeys()
    {
        // imarc_openidlogin_record table
        $this->addForeignKey(
            $this->db->getForeignKeyName('{{%imarc_openidlogin_record}}', 'userId'),
            '{{%imarc_openidlogin_record}}',
            'userId',
            '{{%users}}',
            'id',
    ...
    {
    // imarc_openidlogin_record table
        $this->dropTableIfExists('{{%imarc_openidlogin_record}}');
    }
}
